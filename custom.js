...
var shop = 'rasengan01',
    ...
    redirectUri = 'https://ebraheempitchprint.github.io/Bedankjes/custom.js',
    nonce = 2000,
    access_mode = 'value';

if (localStorage.getItem("_i") === null) {
    window.location.href = `https://${shop}.myshopify.com/admin/oauth/authorize?client_id=${api_key}&scope=${scopes}&redirect_uri=${redirect_uri}&state=${nonce}&grant_options[]=${access_mode}`;
